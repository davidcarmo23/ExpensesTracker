...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Categories>|Categories whereDeleted($value)
     ...
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereCurrencyName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereCurrencySymbol($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies whereDeleted($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Currencies>|Currencies query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @property-read \App\Models\Currencies $currency
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Expenses>|Expenses whereValue($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Expenses>|Expenses whereCurrencyId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Expenses>|Expenses whereCurrencySymbol($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Expenses>|Expenses whereDeleted($value)
